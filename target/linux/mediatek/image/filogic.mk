...
define Device/cmcc_rax3000me-an8855
  DEVICE_VENDOR := CMCC
  DEVICE_MODEL := RAX3000Me AN8855
  DEVICE_DTS := mt7981b-cmcc-rax3000me-an8855
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware \
	kmod-usb-net-cdc-mbim kmod-usb-net-qmi-wwan kmod-usb-serial-option \
	kmod-usb3 automount f2fsck mkf2fs uqmi coremark blkid blockdev fdisk
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
endef
TARGET_DEVICES += cmcc_rax3000me-an8855
...
define Device/cudy_tr3000-v1-256mb
  DEVICE_VENDOR := Cudy
  DEVICE_MODEL := TR3000
  DEVICE_VARIANT := v1 256ROM versions
...
define Device/cudy_wr3000e-v1
  DEVICE_VENDOR := Cudy
  DEVICE_MODEL := WR3000EMore actions
  DEVICE_VARIANT := v1
...
define Device/cudy_wr3000h-v1
  DEVICE_VENDOR := CudyMore actions
...
define Device/umi_uax3000e
  ...
  DEVICE_PACKAGES := kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware \
	kmod-usb-net-cdc-mbim kmod-usb-net-qmi-wwan kmod-usb-serial-option \
	kmod-usb3 automount coremark blkid blockdev fdisk f2fsck mkf2fs kmod-mmc mmc-utils
  KERNEL := kernel-bin | lzma | fit lzma $$(KDIR)/image-$$(firstword $$(DEVICE_DTS)).dtb
  KERNEL_INITRAMFS := kernel-bin | lzma | \
	fit lzma $$(KDIR)/image-$$(firstword $$(DEVICE_DTS)).dtb with-initrd | pad-to 64k
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
